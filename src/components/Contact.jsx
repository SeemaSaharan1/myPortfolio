    ...
    <div name="contact" className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white '>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center item-center'>
                <form action="https://getform.io/f/paqgdpra" method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    <button className='text-white px-6 py-3 bg-gradient-to-b from-cyan-500 to-blue-500 my-8 mx-auto flex items-center rounded-md hover:scale-105 duration-300'>Let's Talk</button>
