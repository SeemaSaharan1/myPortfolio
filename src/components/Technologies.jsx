...
const Technologies = () => {
  ...
  return (
    <div name="technologies" className='w-full h-screen bg-gradient-to-b from-gray-800 to-black'>
        <div className='mx-auto p-4 flex flex-col justify-center max-w-screen-lg w-full h-full text-white'>
          <div>
            <p className='text-4xl font-bold border-b-4 border-gray-500 p-2 inline'>Techologies</p>
